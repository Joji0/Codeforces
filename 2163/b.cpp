...
void solve() {
    ...
    auto it1 = find(all(p), 1), it2 = find(all(p), n);
    if (s[it1 - p.begin()] == '1' || s[it2 - p.begin()] == '1') {
        ok = false;
    }
    if (!ok) {
        cout << "-1\n";
    ...
    cout << "5\n";
    cout << 1 << " " << it1 - p.begin() + 1 << '\n';
    cout << 1 << " " << it2 - p.begin() + 1 << '\n';
    cout << it1 - p.begin() + 1 << " " << n << '\n';
    cout << it2 - p.begin() + 1 << " " << n << '\n';
    cout << min(it1 - p.begin() + 1, it2 - p.begin() + 1) << " "
         << max(it1 - p.begin() + 1, it2 - p.begin() + 1) << '\n';
}
