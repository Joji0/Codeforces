...
void solve() {
        ...
        int a12, a13, a23;
        a12 = ask_or(1, 2) + ask_and(1, 2), a13 = ask_or(1, 3) + ask_and(1, 3), a23 = ask_or(2, 3) + ask_and(2, 3);
        int diff = a12 - a13, a2 = (diff + a23) / 2, a3 = a23 - a2, a1 = a12 - a2;
        vector<int> A = {a1, a2, a3};
        for (int i = 4; i <= N; i++) {
                int a1i = ask_or(1, i) + ask_and(1, i);
                int a_now = a1i - a1;
                A.push_back(a_now);
        }
        sort(A.begin(), A.end());
